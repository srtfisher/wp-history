<?php
/**
 * Static Interpretation of the Amazing Class that Phil Sturgeon Wrote
 *
 * @package wphistory
 */
namespace Wphistory;
...
class CommandLine {
    ...
    /**
     * Init.    Parses all the CLI params.
     */
    ...
    public static function prompt()
    {
        ...
        if (empty($input) and $required === true)
        {
            ...
            $input = call_user_func('Cli::prompt', $args);
        }
        ...
        if ( ! empty($options) && ! in_array($input, $options))
        {
            ...
            $input = call_user_func_array('Cli::prompt', $args);
        }
